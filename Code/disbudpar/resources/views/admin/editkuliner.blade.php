        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="POST" action="{{ route('updatekuliner',$kuliner->id) }}" enctype="multipart/form-data">
              @csrf
                <div class="form-group">
                  <label for="nama_travel" class="col-sm-2 col-sm-2 control-label">{{ __('Nama Travel') }}</label>
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="nama_kuliner" name="nama_kuliner" value="{{$kuliner->nama_kuliner}}" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="detail_kuliner" class="col-sm-2 col-sm-2 control-label">{{ __('Detail Kuliner') }}</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" name="detail_kuliner" id="detail_kuliner" rows="5" required>{{$kuliner->detail_kuliner}}</textarea>
                  </div>
                </div>
                <div class="form-group">
                    <label for="pemilik" class="col-sm-2 col-sm-2 control-label">{{ __('Pemilik') }}</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="pemilik" name="pemilik" value="{{$kuliner->pemilik}}" required>
                    </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      ...
                      <option selected disabled>{{$kuliner->id_kabupaten}}</option>
                      </select>
                  </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="alamat" name="alamat" value="{{$kuliner->alamat}}" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="kontak" class="col-sm-2 col-sm-2 control-label">{{ __('Kontak') }}</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="kontak" name="kontak" value="{{$kuliner->kontak}}" required>
                    </div>
                </div>
                <div class="form-group">
