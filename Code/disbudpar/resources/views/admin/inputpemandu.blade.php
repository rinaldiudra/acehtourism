        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="POST" action="{{ route('inputpemandu') }}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group">
                  <label for="suku" class="col-sm-2 col-sm-2 control-label">{{ __('Kabupaten/Kota') }}</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label for="suku" class="col-sm-2 col-sm-2 control-label">{{ __('Alamat') }}</label>
                  <div class="col-sm-10">
