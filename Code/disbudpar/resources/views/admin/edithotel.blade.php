        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="POST" action="{{ route('updatehotel',$hotel->id) }}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="kategori" name="kategori" value="{{$hotel->kategori}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="pimpinan" name="pimpinan" value="{{$hotel->pimpinan}}" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="id_kabupaten" class="col-sm-2 col-sm-2 control-label">{{ __('Kabupaten/Kota') }}</label>
                  <div class="col-sm-10">
                      <select class="form-control" id="id_kabupaten" name="id_kabupaten" data-source="{{url('/getKabupaten')}}" data-valueKey="id" data-displayKey="nama_kabupaten">
                      <option selected disabled>{{$hotel->id_kabupaten}}</option>
                      </select>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="alamat" name="alamat" value="{{$hotel->alamat}}" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="no_telp" class="col-sm-2 col-sm-2 control-label">{{ __('Kontak') }}</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="no_telp" name="no_telp" value="{{$hotel->no_telp}}" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="jumlah_kamar" class="col-sm-2 col-sm-2 control-label">{{ __('Jumlah Kamar') }}</label>
                  <div class="col-sm-10">
                  <input type="number" class="form-control" id="jumlah_kamar" name="jumlah_kamar" value="{{$hotel->jumlah_kamar}}" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="detail_kamar" class="col-sm-2 col-sm-2 control-label">{{ __('Detail Kamar') }}</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" name="detail_kamar" id="detail_kamar" rows="5" required>{{$hotel->detail_kamar}}</textarea>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <br>
                     <img src="{{ url('../storage/app/foto/'.($hotel->foto==NULL?:$hotel->foto)) }}" style="width: 150px; height: 150px;"readonly>
                  <br><br>
                  </div>
                </div>
                <div class="form-group">
