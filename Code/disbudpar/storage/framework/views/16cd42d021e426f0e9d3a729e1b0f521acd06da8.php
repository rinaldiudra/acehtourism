        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="POST" action="<?php echo e(route('updatetravel',$travel->id)); ?>" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
                <div class="form-group">
                  <label for="nama_travel" class="col-sm-2 col-sm-2 control-label"><?php echo e(__('Nama Travel')); ?></label>
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="nama_travel" name="nama_travel" value="<?php echo e($travel->nama_travel); ?>" required>
                  </div>
                </div>
                <div class="form-group">
                    <label for="jenis" class="col-sm-2 col-sm-2 control-label"><?php echo e(__('Jenis Travel')); ?></label>
                    <div class="col-sm-10">
                        <select class="form-control" id="jenis" name="jenis" value="<?php echo e($travel->jenis); ?>">
                            <option selected disabled><?php echo e($travel->jenis); ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="no_izin" name="no_izin" value="<?php echo e($travel->no_izin); ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="pimpinan" class="col-sm-2 col-sm-2 control-label"><?php echo e(__('Pimpinan')); ?></label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="pimpinan" name="pimpinan" value="<?php echo e($travel->pimpinan); ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <option selected disabled><?php echo e($travel->id_kabupaten); ?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo e($travel->alamat); ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="kontak" class="col-sm-2 col-sm-2 control-label"><?php echo e(__('Kontak')); ?></label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="kontak" name="kontak" value="<?php echo e($travel->kontak); ?>" required>
                    </div>
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.layout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\disbudpar\resources\views/admin/edittravel.blade.php ENDPATH**/ ?>