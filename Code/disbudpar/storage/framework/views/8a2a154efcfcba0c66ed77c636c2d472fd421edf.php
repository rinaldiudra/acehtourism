        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="POST" action="<?php echo e(route('inputkuliner')); ?>" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
                <div class="form-group">
                  <label for="nama_kuliner" class="col-sm-2 col-sm-2 control-label"><?php echo e(__('Nama Usaha')); ?></label>
                  <div class="col-sm-10">
...
<?php echo $__env->make('layouts.layout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\disbudpar\resources\views/admin/inputkuliner.blade.php ENDPATH**/ ?>